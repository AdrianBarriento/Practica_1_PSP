...
public class GestionarBBDD {
    public void insertarRegistros(int numRegistros, int numHilos){
        ...
        //calculamos si se queda algún registro fuera en caso de que el número de registros no sea divisible entre el número de hilos pedidos
        int diferencia = numRegistros-(registrosXhilo*numHilos);
